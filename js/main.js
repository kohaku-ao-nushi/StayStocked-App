...
const todoMasterList = [
  ...
  { id: 'tissue', name: 'ティッシュペーパー', category: '衛生用品', unit: '箱', calc: (p, days) => Math.ceil(days / 7) * 2, isNeeded: p => p.totalPeople > 0 }, // ★ 東京備蓄ナビの推奨量「3箱」に合わせるため、計算式を調整 [cite: 62]
  { id: 'toilet_paper', name: 'トイレットペーパー', category: '衛生用品', unit: 'ロール', calc: (p, days) => Math.ceil(p.totalPeople * days / 10), isNeeded: p => p.totalPeople > 0 }, // ★ 1人1日あたりの使用量を考慮し計算式を調整 [cite: 60]
  ...
  { id: 'cassette_gas', name: 'カセットボンベ', category: '生活用品', unit: '本', calc: (p, days) => Math.ceil(days * (4/3)), isNeeded: p => p.totalPeople > 0 }, // ★ 計算式を東京備蓄ナビに準拠 [cite: 53]
  ...
  { id: 'headlight', name: 'ヘッドライト', category: '生活用品', unit: '個', calc: p => p.totalPeople, isNeeded: p => p.totalPeople > 0 }, // ★ 新規追加 [cite: 81]
